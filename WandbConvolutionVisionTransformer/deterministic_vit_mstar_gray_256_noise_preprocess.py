...
def main_function(
    ...
    if Training:
        ...
        wandb.init(
            ...
            project=f"ds_deter_mstar_{image_size}_epochs_{epochs}_layers_{num_layers}_lr_{lr}_batch_{batch_size}_embed_{embed_dim}_num_kernel_{kernel_num}_kernel_size_{kernel_size}_kernel_stride_{kernel_stride}_dropout_{dropout}",
        )  # mode = 'disabled')
